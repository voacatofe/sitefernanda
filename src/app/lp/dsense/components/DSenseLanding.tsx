  ...
  return (
    <div className="min-h-screen bg-white text-dimas-black">
      ...
      >
        ...
        <Image
          src="/images/dsense/frente-parque.0f31bc9e.jpg"
          alt="D'SENSE - Background"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-fernanda-gold">
              Exclusividade e praticidade para seu estilo de vida
            </p>
            <Button
              variant="outline"
              size="lg"
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-600">
                <li className="flex items-center gap-2">
                  ...
                  <span>Arquitetura moderna e funcional</span>
                </li>
                <li className="flex items-center gap-2">
                  <Check className="text-fernanda-gold" />
                  <span>Ampla área de lazer com diversas opções</span>
                </li>
                <li className="flex items-center gap-2">
                  <Check className="text-fernanda-gold" />
                  <span>Espaços pensados para seu bem-estar</span>
                </li>
                <li className="flex items-center gap-2">
                  <Check className="text-fernanda-gold" />
                  <span>Segurança e conveniência em todos os ambientes</span>
                </li>
              </ul>
            </div>
          </FadeInSection>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-600">
                  <li className="flex items-center gap-2">
                    ...
                    <span>Proximidade a centros comerciais e supermercados</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Building className="text-fernanda-gold" />
                    <span>Fácil acesso a escolas e universidades</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Phone className="text-fernanda-gold" />
                    <span>Próximo às principais vias de transporte</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Mail className="text-fernanda-gold" />
                    <span>Região com completa infraestrutura de serviços</span>
                  </li>
                </ul>
              </div>
            </FadeInSection>
            <FadeInSection>
              <div className="relative h-[400px] w-full overflow-hidden mb-6 rounded-lg shadow-md">
                <Image
                  src="/images/dsense/localização.png"
                  alt="Localização D'SENSE"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
      ...
      <footer className="py-8 bg-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm text-gray-300">
            © {new Date().getFullYear()} D'SENSE. Todos os direitos reservados. 
