...
export function DVerseLanding({
  ...
  return (
    <div className="min-h-screen bg-white text-dimas-black">
      ...
      >
        <video
          src="/images/dverse/background-lp.mp4"
          autoPlay
          loop
          muted
          playsInline
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white">
              Seu novo lar a 65m da Praia Brava
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-fernanda-gold">
              Luxo, conforto e localização privilegiada
            </p>
            <Button
              variant="outline"
              size="lg"
...
e encantadoras de Florianópolis, este novo
lançamento é destinado àqueles que buscam
um refúgio tranquilo e privilegiado.<br></br><br></br>



Uma praia frequentada predominantemente
por moradores locais e visitantes seletos, este
empreendimento oferecerá a privacidade e a
tranquilidade de uma segunda moradia perfeita.
              ...
              <ul className="space-y-4 text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  <Check className="text-fernanda-gold" />
                  <span>Área de lazer completa</span>
                </li>
                <li className="flex items-center gap-2">
                  <Check className="text-fernanda-gold" />
                  <span>Vista permanente para o mar</span>
                </li>
                <li className="flex items-center gap-2">
                  <Check className="text-fernanda-gold" />
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-600">
                  <li className="flex items-center gap-2">
                    ...
                    <span>65m da Praia Brava</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Building className="text-fernanda-gold" />
                    <span>Próximo ao comércio local</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Phone className="text-fernanda-gold" />
                    <span>Fácil acesso às principais vias</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Mail className="text-fernanda-gold" />
                    <span>Região em constante valorização</span>
                  </li>
                </ul>
              </div>
            </FadeInSection>
